...
#        
#
#        G <- gmat[rownames(tmat), colnames(tmat)] %>% as.matrix()
#
#
#        n.feat <- 1200
#
...
#        gc()
#
#        RHS <- c(sum(yy[1:1710])*r.no,sum(yy[1711:1910]),c(yy[1:1710]*r.no,yy[1711:1910],rep(0,200)),c(yy[1711:1910],rep(0,200)),c(yy[1:1710]*r.no,yy#[1711:1910],rep(0,200)))
#
#        SOL <- solve(LHS, RHS)
#
